...
void Output::Drawsquare(Point P1, GfxInfo RectGfxInfo, bool selected) const
{
	...
	int i = 50;
	pWind-> DrawRectangle( P1.x-i, P1.y-i, P1.x+i, P1.y+i, style);
...
{
	int xvert[6] = { P1.x - 40 , P1.x - 40 , P1.x , P1.x + 40 , P1.x + 40 , P1.x };
	int yvert[6] = { P1.y + 40 , P1.y - 40 , P1.y - 80 , P1.y - 40 , P1.y + 40 , P1.y + 80 };
...
void Output::Drawcircle ( Point P1 , Point P2 , GfxInfo RectGfxInfo , bool selected ) const
{
	...
	Point diff;   //the difference between the two points 
	diff.x = P2.x - P1.x;
	diff.y = P2.y - P1.y; 

	int  radius = sqrt ( pow( diff.x , 2 ) + pow ( diff.y , 2 ) ); // calculating the radius of circle
