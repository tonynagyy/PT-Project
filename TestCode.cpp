...
int main()
{
	...
	do
	{
		...
		case F1:
			pOut->PrintMessage("Action: FigureType , Click anywhere");
			break;

		case F2:
			pOut->PrintMessage("Action: FigureColourFill , Click anywhere");
			break;

		case F3:
			pOut->PrintMessage("Action: Type&&ColourFill , Click anywhere");
			break;
